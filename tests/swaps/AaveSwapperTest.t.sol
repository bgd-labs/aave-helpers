...
contract AaveSwapperTest is Test {
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 22840306);
...
contract CancelSwap is AaveSwapperTest {
  ...
  function test_successful() public {
    ...
    swaps.cancelSwap(
      0x6bBDfE47a3742fb966424066bBdC1086E81Ace4F, // Address generated by tests
      CHAINLINK_PRICE_CHECKER,
      AaveV2EthereumAssets.AAVE_UNDERLYING,
      AaveV2EthereumAssets.USDC_UNDERLYING,
      AaveV2EthereumAssets.AAVE_ORACLE,
...
contract GetExpectedOut is AaveSwapperTest {
  ...
  function test_aaveToUsdc_withEthBasedOracles() public view {
    ...
    assertEq(expected / 1e4, 27598); // USDC is 6 decimals
  }
  ...
  function test_aaveToUsdc() public view {
    ...
    // July 3, 2025 AAVE/USD is around $276
    assertEq(expected / 1e4, 28010); // USDC is 6 decimals
  }
  ...
  function test_ethToDai() public view {
    ...
    // July 3, 2025 ETH/USD is around $2,578
    assertEq(expected / 1e18, 2578); // WETH is 18 decimals
  }
  ...
  function test_ethToBal() public view {
    ...
    // July 3, 2024 ETH/BAL is 1 ETH is around 2617 BAL tokens
    assertEq(expected / 1e18, 2617); // WETH and BAL are 18 decimals
  }
  ...
  function test_balTo80BAL20WETH() public view {
    ...
    // July 3, 2025 BAL/USD should be around 2,10 at 100 units traded, 24 units expected.
    assertEq(expected / 1e18, 24); // WETH and BAL are 18 decimals
  }
}
